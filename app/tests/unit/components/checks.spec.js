...
describe('getStatus', () => {
  ...
  const getWebAdeStatusSpy = jest.spyOn(checks, 'getWebAdeOauth2Status');

  beforeEach(() => {
    getChesStatusSpy.mockClear();
    getWebAdeStatusSpy.mockClear();
  });

  afterAll(() => {
    getChesStatusSpy.mockRestore();
    getWebAdeStatusSpy.mockRestore();
  });

  it('should return an array', () => {
    getChesStatusSpy.mockResolvedValue({});
    getWebAdeStatusSpy.mockResolvedValue({});
