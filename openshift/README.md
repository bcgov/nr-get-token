...
Our builds and deployments are orchestrated with Jenkins (see [tools](../tools/README.md)). Refer to[Jenkinsfile](../Jenkinsfile) and [Jenkinsfile.cicd](../Jenkinsfile.cicd) to see how the Openshift templates are used for building and deploying in our CI/CD pipeline.
